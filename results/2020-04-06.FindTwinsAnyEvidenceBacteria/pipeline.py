...
# Proteobacteria
# Bacteria
QUERY="taxonomy:Enterobacterales (locations:(location:cytoplasm) OR locations:(location:cytosol)) NOT annotation:(type:signal)"
FORMAT="tab"
...
QUERY="taxonomy:Enterobacterales locations:(location:periplasm) annotation:(type:signal)"
FORMAT="tab"
COLUMNS="id,organism,ec,sequence"
