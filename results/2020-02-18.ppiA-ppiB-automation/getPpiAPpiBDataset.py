...
ppiA = uniprotRetrieve(query="gene:ppia annotation:(type:signal) taxonomy:gammaproteobacteria",
                form = "tab",
                columns = "id,organism",
                output="ppiA.tab")
ppiB = uniprotRetrieve(query="gene:ppib taxonomy:gammaproteobacteria NOT annotation:(type:signal)",
                form = "tab",
                columns = "id,organism",
                output="ppiB.tab")
